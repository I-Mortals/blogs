...
<p><img src="https://cdn.jsdelivr.net/gh/xugaoyi/image_store/blog/20200103124306.png" alt="主动提交"></p>
<p>具体使用方法就是创建一个文件<code v-pre>urls.txt</code>，文件内每行一条链接的格式写入提交的多个链接，如图。</p>
<p><img src="https://cdn.jsdelivr.net/gh/xugaoyi/image_store/blog/20200103124305.png" alt="urls.txt"></p>
<p>运行命令</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>curl -H 'Content-Type:text/plain' --data-binary @urls.txt &quot;http://data.zz.baidu.com/urls?site=xugaoyi.com&amp;token=T5PEAzhG*****&quot;
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// baiduPush.js
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码仅是针对我个人的博客生成链接到<code v-pre>urls.txt</code>文件。更多代码在 <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/utils/baiduPush.js" target="_blank" rel="noopener noreferrer">这里</a>。</p>
<p>运行如下命令就可以生产一个包含博客所有链接的<code v-pre>urls.txt</code>文件：</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>node utils/baiduPush.js https://xugaoyi.com
...
<p>今天的主角GitHub Actions 要登场了。（相关：<a href="http://www.ruanyifeng.com/blog/2019/09/getting-started-with-github-actions.html?20191227113947#comment-last" target="_blank" rel="noopener noreferrer">GitHub Actions 入门教程</a>、<a href="https://xugaoyi.com/pages/6b9d359ec5aa5019/" target="_blank" rel="noopener noreferrer">GitHub Actions 实现自动部署静态博客</a>）</p>
<p>GitHub Actions 是一个 CI/CD（持续集成/持续部署）工具，但也可用作代码运行环境。<strong>功能非常强大，能够玩出许多花样。</strong></p>
<h3 id="配置-github-actions" tabindex="-1"><a class="header-anchor" href="#配置-github-actions" aria-hidden="true">#</a> 配置 GitHub Actions</h3>
<p>触发 GitHub Actions 需要在项目仓库新建一个<code v-pre>.github/workflows</code>子目录，里面是 <a href="https://xugaoyi.com/pages/4e8444e2d534d14f/" target="_blank" rel="noopener noreferrer">YAML 格式</a>配置文件，文件名可以随便取。GitHub 只要发现配置文件，就会运行 Actions。</p>
<p>配置文件的第一部分是触发条件。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>## baiduPush.yml
name: 'baiduPush'
...
on:
  ...
  schedule:
    - cron: '0 23 * * *'
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码中，<code v-pre>name</code>字段是配置文件的描述，<code v-pre>on</code>字段是触发条件。我们指定两种情况下触发，第一种是代码 Push 进仓库，第二种是<a href="https://help.github.com/en/actions/automating-your-workflow-with-github-actions/events-that-trigger-workflows#scheduled-events-schedule" target="_blank" rel="noopener noreferrer">定时任务</a>，每天在国际标准时间23点（北京时间+8，即早上7点）运行。</p>
<blockquote>
<p>定时设置看<a href="https://help.github.com/en/actions/automating-your-workflow-with-github-actions/events-that-trigger-workflows#scheduled-events-schedule" target="_blank" rel="noopener noreferrer">这里</a></p>
</blockquote>
<p>接着，就是运行流程。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>jobs:
  bot:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码中，指定运行环境是最新的ubuntu，流程的第一步是从代码仓库获取代码，第二步运行两个命令，先安装项目依赖，再运行写在<code v-pre>package.json</code>的<code v-pre>baiduPush</code>命令。完整代码看 <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/.github/workflows/baiduPush.yml" target="_blank" rel="noopener noreferrer">这里</a></p>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// package.json
&quot;scripts&quot;: {
...
<p><a href="https://xugaoyi.com/pages/6b9d359ec5aa5019/" target="_blank" rel="noopener noreferrer">《 GitHub Actions 实现自动部署静态博客》</a></p>
<p><a href="https://xugaoyi.com/pages/41f87d890d0a02af/" target="_blank" rel="noopener noreferrer">《解决百度无法收录搭建在GitHub上的静态博客的问题》</a></p>
</div></template>
