...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code>:root {
  --bg: #fff;
  --textColor: #004050;
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code>body {
  color: var(--bg);
}
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code>/* 定义深色模式的颜色 */
:root {
  --bg: rgb(30,30,34);
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code>/* 根据系统的深色模式响应深色变量 */
...
<p><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/@media/prefers-color-scheme" target="_blank" rel="noopener noreferrer"><code v-pre>prefers-color-scheme</code>文档</a></p>
</blockquote>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>if(window.matchMedia('(prefers-color-scheme: dark)').matches){
  //深色主题
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote>
<p><a href="https://developer.mozilla.org/zh-CN/docs/Web/API/Window/matchMedia" target="_blank" rel="noopener noreferrer"><code v-pre>matchMedia</code></a>方法返回一个<a href="https://developer.mozilla.org/zh-CN/docs/Web/API/MediaQueryList" target="_blank" rel="noopener noreferrer"><code v-pre>MediaQueryList</code></a>对象，该对象具有属性<code v-pre>matches</code>、<code v-pre>media</code>，具有方法<code v-pre>addListener</code>、<code v-pre>removeListener</code>。</p>
</blockquote>
<p><code v-pre>addListener</code>接收一个<code v-pre>MediaQueryList</code>对象作为参数。
为深色模式添加监听器，以响应系统切换到或切换出深色模式：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>let listeners={
  dark:(mediaQueryList )=&gt;{
