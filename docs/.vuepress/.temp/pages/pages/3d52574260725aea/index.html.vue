...
<div class="language-stylus ext-styl line-numbers-mode"><pre v-pre class="language-stylus"><code>.wrapper
  overflow hidden
  width 100%
  height 0
...
<p>更多 <a href="https://www.runoob.com/cssref/css-units.html" target="_blank" rel="noopener noreferrer">CSS单位</a>。</p>
</blockquote>
</div></template>
