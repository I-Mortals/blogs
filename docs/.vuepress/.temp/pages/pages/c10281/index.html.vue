...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code># 首先将 v2 push到远程仓库
git add .
git commit -m 'xxx'
git push origin v2
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code># 查看HEAD指针变动记录
git reflog
# 记录示例(当前分支是v2):
...
*v2
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>2.4-dev</code> 是基于<code v-pre>dev</code>切出来的。</p>
<p>提交记录如下：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>		dev
a - b - c
		v2
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>git rebase v2 # 将 dev-copy 的提交[commit] 变基到(应用到) v2
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>删除原<code v-pre>v2</code>分支，将<code v-pre>dev-copy</code>分支名改为<code v-pre>v2</code></p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code># 当前在 dev-copy 分支
git branch -d v2 # 删除分支
git branch -m dev-copy v2 # 重命名
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
</ol>
<h3 id="git-cherry-pick" tabindex="-1"><a class="header-anchor" href="#git-cherry-pick" aria-hidden="true">#</a> git cherry-pick</h3>
<p>来源：<a href="http://www.ruanyifeng.com/blog/2020/04/git-cherry-pick.html" target="_blank" rel="noopener noreferrer">《git cherry-pick 教程》</a></p>
<p>用于将单个或几个<code v-pre>[commit]</code>复制到另一个分支。</p>
<h4 id="基本应用" tabindex="-1"><a class="header-anchor" href="#基本应用" aria-hidden="true">#</a> 基本应用</h4>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>git cherry-pick &lt;commitHash&gt; # 将commitHash应用于当前分支
...
<h4 id="转移多个提交" tabindex="-1"><a class="header-anchor" href="#转移多个提交" aria-hidden="true">#</a> 转移多个提交</h4>
<p>Cherry pick 支持一次转移多个提交。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>git cherry-pick &lt;HashA&gt; &lt;HashB&gt; # A和B提交
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>git cherry-pick A..B # A到B提交，不包含A
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>git cherry-pick A^..B # A到B提交，包含A
