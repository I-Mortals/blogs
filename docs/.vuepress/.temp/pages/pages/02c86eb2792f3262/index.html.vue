...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>let s = Symbol();
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>let s1 = Symbol('foo');
let s2 = Symbol('bar');
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// 没有参数的情况
let s1 = Symbol();
let s2 = Symbol();
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>let sym = Symbol('My symbol');
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>let sym = Symbol();
Boolean(sym) // true
!sym  // false
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>const sym = Symbol('foo');
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的用法不是很方便。<a href="https://github.com/tc39/proposal-Symbol-description" target="_blank" rel="noopener noreferrer">ES2019</a> 提供了一个实例属性<code v-pre>description</code>，直接返回 Symbol 的描述。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>const sym = Symbol('foo');
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>let mySymbol = Symbol();
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>const mySymbol = Symbol();
const a = {};
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>const log = {};
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>const COLOR_RED    = Symbol();
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>function getArea(shape, options) {
  let area = 0;
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>const shapeType = {
  triangle: 'Triangle'
};
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>let size = Symbol('size');
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>let s1 = Symbol.for('foo');
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>Symbol.for(&quot;bar&quot;) === Symbol.for(&quot;bar&quot;)
// true
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>iframe = document.createElement('iframe');
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>const a = require('./mod.js');
console.log(a.foo);
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>global._foo = { foo: 'world' };
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>global[Symbol.for('foo')] = { foo: 'world' };
...
<p>下面是另一个例子。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>class Even {
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>let arr1 = ['c', 'd'];
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>let obj = {length: 2, 0: 'c', 1: 'd'};
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>class A1 extends Array {
  constructor(args) {
    super(args);
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>static get [Symbol.species]() {
  return this;
}
...
<p>再看一个例子。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>class T1 extends Promise {
}
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>String.prototype.match(regexp)
// 等同于
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>String.prototype.replace(searchValue, replaceValue)
// 等同于
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>const x = {};
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>String.prototype.search(regexp)
// 等同于
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>String.prototype.split(separator, limit)
// 等同于
separator[Symbol.split](this, limit)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下面是一个例子。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>class MySplitter {
  constructor(value) {
    this.value = value;
  }
  [Symbol.split](string) {
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>const myIterable = {};
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>class Collection {
  *[Symbol.iterator]() {
    let i = 0;
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>Array.prototype[Symbol.unscopables]
// {
//   copyWithin: true,
//   entries: true,
//   fill: true,
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// 没有 unscopables 时
class MyClass {
  foo() { return 1; }
}
