...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>import { isPlainObject } from './util'
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>export function isPlainObject (val: any): val is Object {
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>if (isDate(val)) {
  val = val.toISOString()
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>// export function isObject (val: any): val is Object {
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>import { transformRequest } from './helpers/data'
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>router.post('/base/post', function(req, res) {
  res.json(req.body)
})
