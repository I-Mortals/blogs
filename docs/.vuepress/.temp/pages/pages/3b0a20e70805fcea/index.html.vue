<template><div><h1 id="vue中使用animate-css库" tabindex="-1"><a class="header-anchor" href="#vue中使用animate-css库" aria-hidden="true">#</a> vue中使用Animate.css库</h1>
<h2 id="自定义过渡类名" tabindex="-1"><a class="header-anchor" href="#自定义过渡类名" aria-hidden="true">#</a> 自定义过渡类名</h2>
...
<!-- more -->
<p>他们的优先级高于普通的类名，这对于 Vue 的过渡系统和其他第三方 CSS 动画库，如 <a href="https://daneden.github.io/animate.css/" target="_blank" rel="noopener noreferrer">Animate.css</a>结合使用十分有用。</p>
...
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code>&lt;transition
    ...
    &lt;p v-if=&quot;show&quot;&gt;hello&lt;/p&gt;
&lt;/transition&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>按 <a href="https://github.com/daneden/animate.css" target="_blank" rel="noopener noreferrer">官方文档</a> 引入Animate.css库，再配合vue的自定义过渡类名，指定<code v-pre>enter-active-class</code>和<code v-pre>leave-active-class</code>的自定义类，两者都要有<code v-pre>animated</code>类，用于说明其使用的是Animate.css库，再根据需求定义另外一个<code v-pre>动画类名</code>。</p>
<p>动画类名：在 <a href="https://daneden.github.io/animate.css/" target="_blank" rel="noopener noreferrer">Animate官网</a> 获取。</p>
