...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>var a = 10
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>function f(shouldInitialize) {
  if (shouldInitialize) {
    var x = 10
  }
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>function sumMatrix(matrix) {
  var sum = 0
...
<p>猜一下下面的代码会返回什么：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>for (var i = 0; i &lt; 10; i++) {
  setTimeout(function() {
    console.log(i)
  }, 100 * i)
}
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>10
10
10
10
10
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>0
1
2
3
4
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>let hello = 'Hello!'
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>function f(input: boolean) {
  let a = 100
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>try {
  throw 'Oh no!';
}
catch (e) {
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>a++ // TS2448: Block-scoped variable 'a' used before its declaration.
let a
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>function foo() {
  // okay to capture 'a'
  return a
}
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let x = 10
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>function f(x) {
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>function f(condition, x) {
  if (condition) {
    let x = 100
    return x
  }
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>function sumMatrix(matrix: number[][]) {
  let sum = 0
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>for (let i = 0; i &lt; 10 ; i++) {
  setTimeout(function() {
    console.log(i)
  }, 100 * i)
}
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>const numLivesForCat = 9
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let input = [1, 2]
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let first = input[0]
let second = input[1]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>作用于函数参数：</p>
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let input: [number, number] = [1, 2]
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let [first, ...rest] = [1, 2, 3, 4]
console.log(first) // outputs 1
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let [first] = [1, 2, 3, 4]
console.log(first) // outputs 1
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>或其它元素：</p>
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let [, second, , fourth] = [1, 2, 3, 4]
...
<p>你也可以解构对象：</p>
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let o = {
    a: 'foo',
    b: 12,
    c: 'bar'
}
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let { a, ...passthrough } = o
...
<p>你也可以给属性以不同的名字：</p>
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let { a: newName1, b: newName2 } = o
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let newName1 = o.a
let newName2 = o.b
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let {a, b}: {a: string, b: number} = o
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>function keepWholeObject(wholeObject: { a: string, b?: number }) {
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>type C = { a: string, b?: number }
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>function f({ a = '', b = 0 } = {}): void {
  // ...
}
f()
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>function f({ a, b = 0 } = { a: '' }): void {
  // ...
}
f({ a: 'yes' }) // OK, 默认 b = 0
f() // OK, 默认 a: '', b = 0
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let first = [1, 2]
let second = [3, 4]
...
<p>你还可以展开对象：</p>
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let defaults = { food: 'spicy', price: '$10', ambiance: 'noisy' }
