...
<blockquote>
<p>本文转自<a href="https://www.cnblogs.com/tzyy/p/5193811.html" target="_blank" rel="noopener noreferrer">https://www.cnblogs.com/tzyy/p/5193811.html</a>，作者：TZYY</p>
</blockquote>
...
<li>
<p>创建一个模块前可以先到后边的网址查查<code v-pre>name</code>是否已经被占用. <a href="https://www.npmjs.com/" target="_blank" rel="noopener noreferrer">https://www.npmjs.com/</a></p>
<ul>
<li>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code># 发布一个包的时候，需要检验某个包名是否存在
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code>{ &quot;license&quot; : &quot;MIT&quot; }
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>你可以在<a href="https://spdx.org/licenses/" target="_blank" rel="noopener noreferrer">https://spdx.org/licenses/ </a>这个地址查阅协议列表 。</p>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>&quot;Barney Rubble b@rubble.com (http://barnyrubble.tumblr.com/)&quot;
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code>&quot;repository&quot; :
  {
      &quot;type&quot; : &quot;git&quot;,
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code>&quot;repository&quot;: &quot;npm/npm&quot;
...
具体的内容有 install start stop 等，详见<a href="https://docs.npmjs.com/misc/scripts" target="_blank" rel="noopener noreferrer"> https://docs.npmjs.com/misc/scripts</a></p>
<h2 id="config" tabindex="-1"><a class="header-anchor" href="#config" aria-hidden="true">#</a> config</h2>
<p>用来设置一些项目不怎么变化的项目配置，例如port等。
用户用的时候可以使用如下用法：</p>
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code>http.createServer(...).listen(process.env.npm_package_config_port)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>可以通过npm config set foo:port 80来修改config。详见<a href="https://docs.npmjs.com/misc/config" target="_blank" rel="noopener noreferrer">https://docs.npmjs.com/misc/config</a></p>
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code>{ 
    &quot;name&quot; : &quot;foo&quot;, 
    &quot;config&quot; : { &quot;port&quot; : &quot;8080&quot; }
}
...
不要把测试工具或transpilers写到dependencies中。 下面是一些写法，详见<a href="https://docs.npmjs.com/misc/semver" target="_blank" rel="noopener noreferrer">https://docs.npmjs.com/misc/semver</a></p>
<ul>
...
<li>tag 发布的一个特殊的标签，见npm-tag的文档 <a href="https://docs.npmjs.com/getting-started/using-tags" target="_blank" rel="noopener noreferrer">https://docs.npmjs.com/getting-started/using-tags</a></li>
<li>path/path/path 见下面本地模块的说明
下面的写法都是可以的:</li>
</ul>
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code>{ &quot;dependencies&quot; :
...
<p>Git url可以像下面一样:</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>git://github.com/user/project.git#commit-ish
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>../foo/bar
~/foo/bar
./foo/bar
/foo/bar
...
例如:</p>
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code>{ &quot;name&quot;: &quot;ethopia-waza&quot;,
