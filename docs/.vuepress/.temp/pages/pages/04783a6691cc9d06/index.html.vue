...
<p><a href="https://cn.vuejs.org/v2/guide/list.html#%E6%95%B0%E7%BB%84%E6%9B%B4%E6%96%B0%E6%A3%80%E6%B5%8B" target="_blank" rel="noopener noreferrer">数组更新检测API</a> <a href="https://cn.vuejs.org/v2/guide/list.html#%E5%AF%B9%E8%B1%A1%E5%8F%98%E6%9B%B4%E6%A3%80%E6%B5%8B%E6%B3%A8%E6%84%8F%E4%BA%8B%E9%A1%B9" target="_blank" rel="noopener noreferrer">对象更新检测API</a></p>
...
<p><a href="https://xugaoyi.com/pages/74d2ab3fbfeaaa68/#_3%E3%80%81%E5%AE%9E%E4%BE%8B%E6%96%B9%E6%B3%95" target="_blank" rel="noopener noreferrer">数组实例方法</a></p>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>example1.items = example1.items.filter(function (item) {
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// Vue.set
Vue.set(vm.items, indexOfItem, newValue)
// Array.prototype.splice
vm.items.splice(indexOfItem, 1, newValue)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>你也可以使用 <a href="https://cn.vuejs.org/v2/api/#vm-set" target="_blank" rel="noopener noreferrer"><code v-pre>vm.$set</code></a> 实例方法，该方法是全局方法 <code v-pre>Vue.set</code> 的一个别名：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>vm.$set(vm.items, indexOfItem, newValue)
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>vm.items.splice(newLength)
...
<blockquote>
<p>列表循环对象示例</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code>&lt;div v-for=&quot;(item, key, index) in obj&quot;&gt;
&lt;/div&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div></blockquote>
<p>还是由于 JavaScript 的限制，<strong>Vue 不能检测对象属性的添加或删除</strong>：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>var vm = new Vue({
  data: {
    a: 1
  }
})
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>Vue.set(vm.userProfile, 'age', 27)
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>vm.$set(vm.userProfile, 'age', 27)
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>Object.assign(vm.userProfile, {
  age: 27,
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>vm.userProfile = Object.assign({}, vm.userProfile, {
  age: 27,
  favoriteColor: 'Vue Green'
})
...
<p>三、Vue.set() 语法：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// 向数组更新数据
Vue.set(vm.items, indexOfItem, newValue)
