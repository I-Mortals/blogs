<template><div><h1 id="子组件派发事件和值给父组件" tabindex="-1"><a class="header-anchor" href="#子组件派发事件和值给父组件" aria-hidden="true">#</a> 子组件派发事件和值给父组件</h1>
<p><a href="https://cn.vuejs.org/v2/guide/components.html#%E7%9B%91%E5%90%AC%E5%AD%90%E7%BB%84%E4%BB%B6%E4%BA%8B%E4%BB%B6" target="_blank" rel="noopener noreferrer">API</a></p>
<p>子组件通过<code v-pre>$emit</code>派发事件和值给父组件（值可以有多个）</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>this.$emit('fnX', value)
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>&lt;ComponentName @fnX=&quot;fnY&quot;&gt;&lt;/ComponentName&gt;
