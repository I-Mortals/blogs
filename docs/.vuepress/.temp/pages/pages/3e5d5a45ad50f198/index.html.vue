...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>import resolve from 'rollup-plugin-node-resolve'
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>function processCancel(): void {
  if (cancelToken) {
    cancelToken.promise
      .then(reason =&gt; {
        request.abort()
