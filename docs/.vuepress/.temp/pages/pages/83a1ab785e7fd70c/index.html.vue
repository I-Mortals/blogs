...
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code>&lt;tbody&gt;
    &lt;tr is=&quot;row&quot;&gt;&lt;/tr&gt;
    &lt;tr is=&quot;row&quot;&gt;&lt;/tr&gt;
    &lt;tr is=&quot;row&quot;&gt;&lt;/tr&gt;
&lt;/tbody&gt;
...
<li><a href="https://cn.vuejs.org/v2/guide/single-file-components.html" target="_blank" rel="noopener noreferrer">单文件组件 (<code v-pre>.vue</code>)</a></li>
<li><a href="https://cn.vuejs.org/v2/guide/components-edge-cases.html#X-Templates" target="_blank" rel="noopener noreferrer"><code v-pre>&lt;script type=&quot;text/x-template&quot;&gt;</code></a></li>
</ul>
<h2 id="子组件内的data要使用函数返回" tabindex="-1"><a class="header-anchor" href="#子组件内的data要使用函数返回" aria-hidden="true">#</a> 子组件内的data要使用函数返回</h2>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>Vue.component('row', {
    data() {
        return {
...
<p><a href="https://cn.vuejs.org/v2/api/#ref" target="_blank" rel="noopener noreferrer">ref</a></p>
<p>虽然并不推荐我们在使用vue的时候操作DOM，但是某些情况下我们必须要操作DOM来实现一些功能，因此可以通过ref引用的形式来获取到DOM节点。</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code>&lt;!-- `vm.$refs.p` 指向DOM元素节点 --&gt;
&lt;p ref=&quot;p&quot;&gt;hello&lt;/p&gt;
