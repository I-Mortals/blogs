<template><div><h1 id="参考链接" tabindex="-1"><a class="header-anchor" href="#参考链接" aria-hidden="true">#</a> 参考链接</h1>
<h2 id="官方文件" tabindex="-1"><a class="header-anchor" href="#官方文件" aria-hidden="true">#</a> 官方文件</h2>
<ul>
<li><a href="http://www.ecma-international.org/ecma-262/6.0/index.html" target="_blank" rel="noopener noreferrer">ECMAScript® 2015 Language Specification</a>: ECMAScript 2015 规格</li>
<li><a href="http://www.ecma-international.org/ecma-262/7.0/" target="_blank" rel="noopener noreferrer">ECMAScript® 2016 Language Specification</a>: ECMAScript 2016 规格</li>
...
<h2 id="综合介绍" tabindex="-1"><a class="header-anchor" href="#综合介绍" aria-hidden="true">#</a> 综合介绍</h2>
<ul>
<li>Axel Rauschmayer, <a href="http://exploringjs.com/es6/" target="_blank" rel="noopener noreferrer">Exploring ES6: Upgrade to the next version of JavaScript</a>: ES6 的专著，本书的许多代码实例来自该书</li>
...
<li>Jeremy Fairbank, <a href="https://speakerdeck.com/jfairbank/html5devconf-es7-and-beyond" target="_blank" rel="noopener noreferrer">HTML5DevConf ES7 and Beyond!</a>: ES7 新增语法点介绍</li>
...
<h2 id="let-和-const" tabindex="-1"><a class="header-anchor" href="#let-和-const" aria-hidden="true">#</a> let 和 const</h2>
<ul>
...
<li>Mathias Bynens, <a href="https://mathiasbynens.be/notes/globalthis" target="_blank" rel="noopener noreferrer">A horrifying <code v-pre>globalThis</code> polyfill in universal JavaScript</a>：如何写 globalThis 的垫片库</li>
</ul>
...
<li>Yang Guo, <a href="http://v8project.blogspot.jp/2016/02/regexp-lookbehind-assertions.html" target="_blank" rel="noopener noreferrer">RegExp lookbehind assertions</a>：介绍后行断言</li>
<li>Axel Rauschmayer, <a href="http://2ality.com/2017/05/regexp-named-capture-groups.html" target="_blank" rel="noopener noreferrer">ES proposal: RegExp named capture groups</a>: 具名组匹配的介绍</li>
...
<h2 id="数值" tabindex="-1"><a class="header-anchor" href="#数值" aria-hidden="true">#</a> 数值</h2>
<ul>
...
<li>Mathias Bynens, <a href="https://developers.google.com/web/updates/2018/05/bigint" target="_blank" rel="noopener noreferrer">BigInt: arbitrary-precision integers in JavaScript</a></li>
</ul>
...
<li>Cynthia Lee, <a href="https://medium.freecodecamp.org/when-and-why-you-should-use-es6-arrow-functions-and-when-you-shouldnt-3d851d7f0b26" target="_blank" rel="noopener noreferrer">When you should use ES6 arrow functions — and when you shouldn’t</a>: 讨论箭头函数的适用场合</li>
<li>Eric Elliott, <a href="https://medium.com/javascript-scene/what-is-this-the-inner-workings-of-javascript-objects-d397bfa0708a" target="_blank" rel="noopener noreferrer">What is this?</a>: 箭头函数内部的 this 的解释。</li>
</ul>
...
<li>David Titarenco, <a href="https://dvt.name/2018/06/02/spread-syntax-breaks-javascript/" target="_blank" rel="noopener noreferrer">How Spread Syntax Breaks JavaScript</a>: 扩展运算符的一些不合理的地方</li>
</ul>
...
<h2 id="set-和-map" tabindex="-1"><a class="header-anchor" href="#set-和-map" aria-hidden="true">#</a> Set 和 Map</h2>
<ul>
...
<h2 id="proxy-和-reflect" tabindex="-1"><a class="header-anchor" href="#proxy-和-reflect" aria-hidden="true">#</a> Proxy 和 Reflect</h2>
<ul>
...
<li>Tom Van Cutsem, <a href="https://github.com/tvcutsem/harmony-reflect/blob/master/doc/traps.md" target="_blank" rel="noopener noreferrer">Proxy Traps</a>: Proxy 拦截操作一览</li>
<li>Tom Van Cutsem, <a href="https://github.com/tvcutsem/harmony-reflect/blob/master/doc/api.md" target="_blank" rel="noopener noreferrer">Reflect API</a></li>
<li>Tom Van Cutsem, <a href="https://github.com/tvcutsem/harmony-reflect/blob/master/doc/handler_api.md" target="_blank" rel="noopener noreferrer">Proxy Handler API</a></li>
...
<h2 id="iterator" tabindex="-1"><a class="header-anchor" href="#iterator" aria-hidden="true">#</a> Iterator</h2>
<ul>
...
<li>Mahdi Dibaiee, <a href="http://dibaiee.ir/es7-array-generator-comprehensions/" target="_blank" rel="noopener noreferrer">ES7 Array and Generator comprehensions</a>：ES7 的 Generator 推导</li>
...
<h2 id="异步操作和-async-函数" tabindex="-1"><a class="header-anchor" href="#异步操作和-async-函数" aria-hidden="true">#</a> 异步操作和 Async 函数</h2>
<ul>
...
<li>Jafar Husain, <a href="https://github.com/jhusain/asyncgenerator" target="_blank" rel="noopener noreferrer">Asynchronous Generators for ES7</a>: Async 函数的深入讨论</li>
<li>Nolan Lawson, <a href="http://pouchdb.com/2015/03/05/taming-the-async-beast-with-es7.html" target="_blank" rel="noopener noreferrer">Taming the asynchronous beast with ES7</a>: async 函数通俗的实例讲解</li>
...
<li>Mostafa Gaafa, <a href="https://hackernoon.com/6-reasons-why-javascripts-async-await-blows-promises-away-tutorial-c7ec10518dd9" target="_blank" rel="noopener noreferrer">6 Reasons Why JavaScript’s Async/Await Blows Promises Away</a>: Async 函数的6个好处</li>
<li>Mathias Bynens, <a href="https://mathiasbynens.be/notes/async-stack-traces" target="_blank" rel="noopener noreferrer">Asynchronous stack traces: why await beats Promise#then()</a>: async 函数可以保留错误堆栈</li>
</ul>
...
<li>Mathias Bynens, <a href="https://developers.google.com/web/updates/2018/12/class-fields" target="_blank" rel="noopener noreferrer">Public and private class fields</a>：实例属性的新写法的介绍。</li>
</ul>
<h2 id="decorator" tabindex="-1"><a class="header-anchor" href="#decorator" aria-hidden="true">#</a> Decorator</h2>
<ul>
...
<li>Maximiliano Fierro, <a href="http://cocktailjs.github.io/blog/traits-with-es7-decorators.html" target="_blank" rel="noopener noreferrer">Traits with ES7 Decorators</a>: Trait 的用法介绍</li>
...
<li>Bradley Meck, <a href="https://github.com/nodejs/node-eps/blob/master/002-es6-modules.md" target="_blank" rel="noopener noreferrer">ES6 Module Interoperability</a>: 介绍 Node 如何处理 ES6 语法加载 CommonJS 模块</li>
...
<li>Node EPS, <a href="https://github.com/nodejs/node-eps/blob/master/002-es-modules.md" target="_blank" rel="noopener noreferrer">ES Module Interoperability</a>: Node 对 ES6 模块的处理规格</li>
</ul>
<h2 id="二进制数组" tabindex="-1"><a class="header-anchor" href="#二进制数组" aria-hidden="true">#</a> 二进制数组</h2>
<ul>
...
<li>Lars T Hansen, <a href="https://github.com/tc39/ecmascript_sharedmem/blob/master/TUTORIAL.md" target="_blank" rel="noopener noreferrer">Shared memory - a brief tutorial</a></li>
<li>James Milner, <a href="https://www.sitepen.com/blog/2018/09/19/the-return-of-sharedarraybuffers-and-atomics/" target="_blank" rel="noopener noreferrer">The Return of SharedArrayBuffers and Atomics</a></li>
</ul>
<h2 id="simd" tabindex="-1"><a class="header-anchor" href="#simd" aria-hidden="true">#</a> SIMD</h2>
<ul>
