...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let x = 3
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let x = [0, 1, null]
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>let zoo: Animal[] = [new Bee(), new Lion()]
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>window.onmousedown = function(mouseEvent) {
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>window.onmousedown = function(mouseEvent:any) {
...
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code>function createZoo(): Animal[] {
