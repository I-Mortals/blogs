...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// CommonJS模块
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// ES6模块
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// profile.js
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>export function multiply(x, y) {
  return x * y;
};
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>function v1() { ... }
function v2() { ... }
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>export var foo = 'bar';
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>import { lastName as surname } from './profile.js';
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>import {a} from './xxx.js'
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>import {myMethod} from 'util';
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>import 'lodash';
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>import { foo } from 'my_module';
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>require('core-js/modules/es6.symbol');
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// circle.js
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>import * as circle from './circle';
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// export-default.js
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// import-default.js
...
<p>下面比较一下默认输出和正常输出。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// 第一组
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// modules.js
function add(x, y) {
  return x * y;
}
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>import _ from 'lodash';
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>import _, { each, forEach } from 'lodash';
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>export default function (obj) {
  // ···
}
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// MyClass.js
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>export { foo, bar } from 'my_module';
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// 接口改名
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>export { default } from 'foo';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>具名接口改为默认接口的写法如下。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>export { es6 as default } from './someModule';
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>export { default as es6 } from './someModule';
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>import * as someIdentifier from &quot;someModule&quot;;
import someIdentifier from &quot;someModule&quot;;
import someIdentifier, { namedIdentifier } from &quot;someModule&quot;;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>为了做到形式的对称，现在有<a href="https://github.com/leebyron/ecmascript-export-default-from" target="_blank" rel="noopener noreferrer">提案</a>，提出补上这三种复合写法。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>export * as someIdentifier from &quot;someModule&quot;;
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// circleplus.js
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// constants.js 模块
export const A = 1;
export const B = 3;
export const C = 4;
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// constants/db.js
export const db = {
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// constants/index.js
export {db} from './db';
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>// script.js
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>const path = './' + fileName;
...
<p><strong><a href="https://github.com/tc39/proposal-dynamic-import" target="_blank" rel="noopener noreferrer">ES2020提案</a> 引入<code v-pre>import()</code>函数，支持动态加载模块。</strong></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>import(specifier)
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>const main = document.querySelector('main');
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>button.addEventListener('click', event =&gt; {
  import('./dialogBox.js')
  .then(dialogBox =&gt; {
    dialogBox.open();
  })
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>if (condition) {
  import('moduleA').then(...);
} else {
  import('moduleB').then(...);
}
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>import(f())
.then(...);
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>import('./myModule.js')
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>Promise.all([
  import('./module1.js'),
  import('./module2.js'),
  import('./module3.js'),
])
