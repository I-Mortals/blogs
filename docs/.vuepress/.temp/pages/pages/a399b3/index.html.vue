...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>$ git branch
  iss53
* master  # 带星号*表示当前所在分支
  testing
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>$ git branch -v
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>$ git branch --merged # 查看已合并分支列表
  iss53
* master
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>$ git branch --no-merged # 查看未合并的分支列表
  testing
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>$ git branch -d testing
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>$ git branch --no-merged testing
  topicA
  featureB
