...
- WeChat or QQ: <a :href="qqUrl" class='qq'>2237997237</a>
- Email:  <a href="mailto:2237997237@qq.com">2237997237@qq.com</a>
- GitHub: <https://github.com/xiaozeiFl>
- Gitee: <https://gitee.com/not-trace>
...
<script>
  export default {
    data(){
      return {
        qqUrl: 'tencent://message/?uin=2237997237&Site=&Menu=yes'
      }
    },
    mounted(){
      const flag =  navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i);
      if(flag){
        this.qqUrl = 'mqqwpa://im/chat?chat_type=wpa&uin=2237997237&version=1&src_type=web&web_src=oicqzone.com'
      }
    }
  }
</script>
